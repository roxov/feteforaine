package fr.asterox.feteforaine.stands.illusionniste;
...
public class Illusionniste extends Stand {
	...
	public void comeIn(List<Player> players, Scanner sc) {
		System.out.println("Vous n'aimez pas particulièrement les magiciens mais celui-ci est très doué.");
